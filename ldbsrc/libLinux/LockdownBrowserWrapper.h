...
#ifndef _Included_com_javaunit_LockdownBrowserWrapper
#define _Included_com_javaunit_LockdownBrowserWrapper
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (Z)V
 */
JNIEXPORT void JNICALL Java_com_javaunit_LockdownBrowserWrapper_TaskSwitching_1Enable_1Disable
  (JNIEnv *, jclass, jboolean);
